...
// SchemeLOCAL is the default value of the Scheme enum.
const DefaultScheme = SchemeLOCAL

// Scheme values.
const (
	SchemeLCSH  Scheme = "LCSH"
	SchemeDDC   Scheme = "DDC"
...
func SchemeValidator(s Scheme) error {
	switch s {
	case SchemeLCSH, SchemeDDC, SchemeLOCAL:
		return nil
	default:
		return fmt.Errorf("subject: invalid enum value for scheme field: %q", s)
	}
}
