...
const (
	// Label holds the string label denoting the libraryrole type in the database.
	Label = "library_role"
	...
	// Table holds the table name of the libraryrole in the database.
	Table = "library_roles"
)

// Columns holds all SQL columns for libraryrole fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the LibraryRole queries.
